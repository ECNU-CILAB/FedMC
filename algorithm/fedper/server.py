...
class SERVER:
    ...
    def federate(self):
        ...
        for i in tqdm(range(self.config.numRounds)):
            ...
            if i == 0 or (i + 1) % self.config.evalInterval == 0:
                ...
                # print and log
                self.printAndLog(i, GM_training_acc_list, GM_training_loss_list, GM_test_acc_list, GM_test_loss_list)
            self.updates = []
    ...
    def printAndLog(self, round_th, GM_training_acc_list, GM_training_loss_list, GM_test_acc_list, GM_test_loss_list):
